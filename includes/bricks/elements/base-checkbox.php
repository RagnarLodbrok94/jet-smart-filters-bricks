...
class Jet_Smart_Filters_Bricks_Base_Checkbox extends Jet_Smart_Filters_Bricks_Base {
	...
	public function register_checkbox_controls( $css_scheme = [] ) {
		...
		include jet_smart_filters_bricks()->plugin_path( 'includes/bricks/elements/common-controls/additional-filter-settings.php' );
		...
		include jet_smart_filters_bricks()->plugin_path( 'includes/bricks/elements/common-controls/additional-filter-style.php' );
	}
